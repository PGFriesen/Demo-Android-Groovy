...
/**
 * This class was created to help organize tooltip messages and keep code clean
 */
public class TooltipHelper {

    private static final String T_USER_ACTION = "User Action monitoring";
    private static final String M_USER_ACTION =  "User Actions are created when a button is clicked\n\n" +
    ...
    private static final String T_USER_ACTION2 = "Modify Automatically Detected User Actions";
    private static final String M_USER_ACTION2 = "Automatic User Actions use the text on the button to create the action name, however, you can also extend and modify the user action by calling \"Dynatrace.modifyUserAction\" inside the click listener for the button\n\n" +
    ...
    private static final String T_WEB_REQUEST = "Web Request";
    private static final String M_WEB_REQUEST = "Clicking the web request button creates the user action, and the slider configures the added delay before the request is fired off to the specified URL.\n\n" +
    ...
    private static final String T_EXCEPTION_HANDLING = "Exception Handling";
    private static final String M_EXCEPTION_HANDLING = "Caught exceptions are not automatically recorded and need to be reported manually, however, they can be manually reported for User Actions in the same manner that we report values or events\n\n" +
    ...
    private static final String T_CRASH_REPORTING = "Crash Reporting";
    private static final String M_CRASH_REPORTING = "The Mobile OneAgent captures all unhandled exceptions and errors and sends the crash report immediatly back to Dynatrace\n\n" +
    ...
    private static final String T_MANUAL_ACTION = "Manual User Actions";
    private static final String M_MANUAL_ACTION = "Custom actions are created with the SDK by calling \"DTXAction act = Dynatrace.enterAction('ActionName')\", and closed with \"act.leaveAction()\"\n\n" +
    ...
    private static final String T_CHILD_ACTION = "Child Actions";
    private static final String M_CHILD_ACTION = "You can add children actions to open user actions by calling \"Dynatrace.enterAction()\" with two parameters\n\n" +
    ...
    private static final String T_MANUAL_WEB_REQUEST = "Manual Web Requests";
    private static final String M_MANUAL_WEB_REQUEST = "IMPORTANT NOTE: IN ORDER TO PREVENT AUTOMATIC TAGGING OF WEB REQUESTS SET 'webRequests.enabled false' IN THE BUILD.GRADLE FILE AND REBUILD THE APP!\n\n" +
    ...
    private static final String T_REPORTING = "Reporting";
    private static final String M_REPORTING = "The main difference with reporting for manual user actions is that instead of calling Dynatrace.modifyUserAction" +
    ...
    private static final String T_DATA_COLLECTION_LEVEL = "DataCollectionLevel";
    private static final String M_DATA_COLLECTION_LEVEL = "The SDK method \"Dynatrace.applyUserPrivacyOptions\" can be called at any time when \"userOptIn\" is set to \"true\" while the app is running to adjust the dataCollectionLevel\n\n" +
    ...
    private static final String T_AUTO_USER_ACTION_CONCEPT = "Automatic User Actions";
    private static final String M_AUTO_USER_ACTION_CONCEPT = "During the app build, the Dynatrace Android Gradle Plugin instruments the following sensors\n\n" +
    ...
    private static final String T_AUTO_WEB_REQUEST_CONCEPT = "Automatic Web Requests";
    private static final String M_AUTO_WEB_REQUEST_CONCEPT = "Web Requests made with the following HTTP Frameworks will be automatically Instrumented\n\n" +
    ...
    private static final String M_MANUAL_USER_ACTION_CONCEPT = "Custom Actions can be created with the SDK and can be a great way to add custom data for both Automatic and Manual Instrumentation\n\n" +
    ...
    private static final String M_MANUAL_WEB_REQUEST_CONCEPT = "For Manual Web Request monitoring, web requests must be manually tagged and timed with the SDK\n\n" +
    ...
    private static final String T_SDK_CONCEPT = "Dynatrace Android SDK";
    private static final String M_SDK_CONCEPT = "The Android OneAgent SDK is made available when using the Dynatrace Android Gradle Plugin to instrument your app\n\n" +
    ...
    private static final String T_PLUGIN_CONCEPT = "Dynatrace Android Gradle Plugin";
    private static final String M_PLUGIN_CONCEPT = "The Plugin serves two main purposes\n\n" +
    ...
    private static final String T_SPLITTING_CONCEPT = "App Termination";
    private static final String M_SPLITTING_CONCEPT = "There are two main ways the app can be terminated to 'end' the session\n\n" +
    ...
    private static final String T_CAG_CONCEPT = "Cluster Activegate for BeaconURL";
    private static final String M_CAG_CONCEPT = "The default BeaconURL that is configured for the Mobile Agent is the Cluster Activegate\n\n" +
    ...
    private static final String T_EAG_CONCEPT = "Environment Activegate as BeaconURL";
    private static final String M_EAG_CONCEPT = "It is possible to specify an Environment Activegate as the BeaconURL in the Mobile Application \"Instrumentation settings\" for the Mobile App in the UI\n\n" +
    ...
    private static final String T_OA_CONCEPT = "Instrumented OneAgent Server for BeaconURL";
    private static final String M_OA_CONCEPT = "Similar to the Environment Activegate as a BeaconURL, an Instrumented OneAgent webserver can also be used as the BeaconURL by choosing this option in the \"Instrumentation settings\" within the UI for the Mobile App\n\n" +
    ...
    private static final String T_ABOUT = "About this app";
    private static final String M_ABOUT = "This Application was created as a learning tool to help teach Dynatrace Mobile Monitoring concepts and provide interactive examples\n\n" +
            ...
            "While the app is designed to teach through use, it is also provided with the source code to see how it works programmatically\n\n" +
            "I hope that this app is helpful in better understanding mobile monitoring, and I am always open to any and all feedback at paul.friesen@dynatrace.com\n\n" +
            "Special shout-out to Don, my original Mobile Mentor\n\n" +
            "Cheers";

    private static final String T_PUREPATH = "Supported Webserver Processes for RUM correlation";
    private static final String M_PUREPATH = "The supported webserver processes for RUM correlation are Java, Apache HTTP Server, IIS, NGINX, and Node.js";

    private static final String T_DISABLE_SENSORS="Disable Instrumentation";
    private static final String M_DISABLE_SENSORS="In the build.gradle file configurations for the plugin, disable functionality to see if the issue still occurs\n\n" +
            "Lifecycle events:\n" +
    ...
    // Check if a concept should have a button or not
